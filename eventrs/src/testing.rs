...
impl TestEventBus {
        ...
        E: Event + 'static,
    {
        ...
        assert_eq!(count, 1, "Expected exactly 1 {} event, but found {}", 
                  E::event_type_name(), count);
    }
    ...
    {
        let count = self.emitted_count::<E>();
        assert_eq!(count, expected, "Expected {} {} events, but found {}", 
                  expected, E::event_type_name(), count);
    }
    ...
    {
        let count = self.emitted_count::<E>();
        assert_eq!(count, 0, "Expected no {} events, but found {}", 
                  E::event_type_name(), count);
    }
    ...
    where
        E: Event + 'static,
    {
        assert!(self.was_emitted::<E>(), "Expected at least one {} event to be emitted", 
               E::event_type_name());
    }
}
...
impl EventSpy {
    ...
    pub fn assert_called_once(&self, method_name: &str) {
        ...
        assert_eq!(count, 1, "Expected {} to be called exactly once, but it was called {} times", 
                  method_name, count);
    }
    ...
    pub fn assert_called_times(&self, method_name: &str, expected: usize) {
        let count = self.call_count(method_name);
        assert_eq!(count, expected, "Expected {} to be called {} times, but it was called {} times", 
    ...
    pub fn assert_not_called(&self, method_name: &str) {
        let count = self.call_count(method_name);
        assert_eq!(count, 0, "Expected {} to never be called, but it was called {} times", 
                  method_name, count);
    }
}
...
mod tests {
    ...
    fn test_event_emission_and_recording() {
        ...
        let event1 = TestEvent { value: 42, message: "Hello".to_string() };
        let event2 = TestEvent { value: 100, message: "World".to_string() };
    ...
    fn test_handler_registration_and_execution() {
        ...
        let event = TestEvent { value: 123, message: "Test".to_string() };
    ...
    fn test_stub_mode() {
        ...
        let event = TestEvent { value: 456, message: "Stub".to_string() };
        test_bus.emit(event.clone()).unwrap();
    ...
    fn test_assertion_methods() {
        ...
        // Emit some events
        test_bus.emit(TestEvent { value: 1, message: "One".to_string() }).unwrap();
        test_bus.emit(TestEvent { value: 2, message: "Two".to_string() }).unwrap();
    ...
    fn test_failure_simulation() {
        ...
        assert!(test_bus.emit(TestEvent { value: 1, message: "Normal".to_string() }).is_ok());
        
        // Enable failure simulation
        test_bus.set_should_fail(true);
        assert!(test_bus.emit(TestEvent { value: 2, message: "Fail".to_string() }).is_err());
        
        // Disable failure simulation
        test_bus.set_should_fail(false);
        assert!(test_bus.emit(TestEvent { value: 3, message: "Normal".to_string() }).is_ok());
    }
    ...
    fn test_mock_handler() {
        ...
        let event1 = TestEvent { value: 10, message: "First".to_string() };
        let event2 = TestEvent { value: 20, message: "Second".to_string() };
    ...
    fn test_processing_delay() {
        ...
        test_bus.emit(TestEvent { value: 1, message: "Delayed".to_string() }).unwrap();
    ...
    fn test_emission_history() {
        ...
        test_bus.emit(TestEvent { value: 1, message: "First".to_string() }).unwrap();
        test_bus.emit(OtherEvent { data: "Second".to_string() }).unwrap();
    ...
    fn test_clear_operations() {
        ...
        test_bus.emit(TestEvent { value: 1, message: "Test".to_string() }).unwrap();
        ...
        test_bus.emit(TestEvent { value: 2, message: "Test2".to_string() }).unwrap();
